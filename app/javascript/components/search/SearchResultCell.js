...
class SearchResultCell extends React.Component {
  ...
  render() {
    return (
      <div className="post-cell card cell mb-2" onClick={() => this.props.showConversation(this.props.result.objectID)}>
        <div className="p-3">
          ...
          <PostActions
            ...
            handleShowComments={() => this.props.showConversation(this.props.result.objectID)}
          />
        </div>
      </div>
    );
